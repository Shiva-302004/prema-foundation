          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <div className="flex items-center space-x-4">
                ...
                <a href="https://www.instagram.com/maa_premafoundation?igsh=MThqbjl3bjBsazhqaw==" target ="_blank" className="text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-500">
